...
public class MaryTTSLocal {
	...
	*/
	...
	/* for Mary.4 */
	public MaryTTSLocal (MaryClient mary, String inputType,  String voiceName, boolean bSilentMode, String audioType, String locale) {
		this.m_mary = mary ;
		this.m_inputType = inputType;
		this.m_voiceName = voiceName ;
		this.m_bSilentMode = bSilentMode;
	 ...
	 */
	   public void  speak(String tosay, final Runnable doThisOnStop)   {
...
//		   		m_mary.process(tosay, m_inputType, "AUDIO", "en_GB", m_audioType, m_voiceName, "", "WAVE", null, m_baos);
				...
				m_mary.process(tosay, "TEXT", "AUDIO", m_locale, "WAVE", m_voiceName, m_baos);
