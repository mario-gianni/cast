...
public class ResolutionResultFactory {
	...
	public static ReferenceResolutionResult potentialToResolutionResult(String nom, WorkingMemoryAddress requestAddr, Potential pot) {
		return new ReferenceResolutionResult(nom, requestAddr, "from-potential", potentialToEpistemicRefHypos(pot));
	}
